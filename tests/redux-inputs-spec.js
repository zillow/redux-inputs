...
describe('updateAndValidate thunk', () => {
    ...
    it('should not remove pristine if nothing changes', () => {
        const expectedActions = [];
    ...
    it('correctly dispatches client side validation changes when errored', () => {
        ...
        thunk((action) => {
            ...
            expect(action).to.deep.equal({
                type: 'RI_SET_INPUT',
                payload: {
                    email: { value: 'previous', error: 'test' }
                },
                error: true,
...
describe('validateInputs thunk', () => {
    ...
    it('fails invalid inputs', () => {
        ...
        thunk((action) => { // Dispatch
            expect(action).to.deep.equal({
                type: 'RI_SET_INPUT',
                payload: { email: { value: undefined, error: '' } },
                error: true,
                meta: { reduxMountPoint: 'inputs', validate: true }
            });
...
describe('initializeInputs thunk', () => {
    it('passes valid inputs', () => {
        ...
        thunk((action) => {
            expect(action).to.deep.equal({
                type: 'RI_SET_INPUT',
                payload: { email: { value: 'test@test.com', pristine: true } },
                error: false,
...
describe('connectWithInputs', () => {
    ...
    it('handles null mapping functions', () => {
        const connectStub = sinon.stub();
        const connectOutput = sinon.stub();
    ...
    it('handles undefined mapping functions', () => {
        const connectStub = sinon.stub();
        const connectOutput = sinon.stub();
